                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <CardContent className="space-y-4">
                            <div className="bg-muted p-4 rounded-lg text-sm">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Al entrenar, la IA analiza tus gastos históricos para aprender tus patrones de consumo personalizados.
                                </p>
                            </div>
                            <Button
                                onClick={handleTrain}
                    ...
                    <Card className="md:col-span-2 border-2 shadow-sm">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Descubre cuánto podrías gastar en una categoría específica según tu situación actual.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
