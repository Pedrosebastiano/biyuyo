...
const BASE_STEPS: TutorialStep[] = [
  ...
  // ── Step 2: Add Transaction Button (NO action — just highlight) ──
  {
    ...
    description: "Este botón te permite crear una nueva transacción en segundos. ¡Toca para registrar gastos, ingresos o recordatorios!",
    route: "/",
    placement: "bottom",
  },
  ...
  // ── Step 8: New Goal Button (NO action — just highlight) ──
  {
    ...
    description: "Toca aquí para definir tu próximo objetivo financiero. Puedes elegir un ícono, establecer un monto y una fecha límite.",
    route: "/goals",
    placement: "bottom",
  },
...
const PREMIUM_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    title: "👥 Menú de Perfiles Compartidos",
    description: "Este es el botón flotante exclusivo para usuarios Premium. Puedes tocarlo en cualquier momento para desplegar opciones avanzadas de perfiles.",
    route: "/",
    placement: "left",
    action: "open-bubble-menu",
  },
  {
    target: "create-profile-menu-item",
    title: "➕ Crear Perfiles",
    description: "Aquí puedes generar un código único para invitar a otras personas a colaborar contigo en una cuenta en conjunto.",
    route: "/",
    placement: "top",
    action: "open-bubble-menu",
  },
  {
    target: "view-profiles-menu-item",
    title: "🔄 Cambiar Perfil Activo",
    description: "Con esta opción podrás saltar fácilmente entre tu entorno personal privado y cualquier perfil compartido al que te hayas unido.",
    route: "/",
    placement: "top",
    action: "open-bubble-menu",
    reverseAction: "close-bubble-menu",
  },
  {
    target: "ver-perfil-modal",
    title: "📋 Panel de Cambio de Cuenta",
    description: "Este panel te permite ver rápidamente todos los perfiles a los que perteneces y saltar entre tu cuenta personal y las compartidas con un solo toque.",
    route: "/",
    placement: "bottom-fixed",
    action: "open-ver-perfil",
    reverseAction: "close-ver-perfil",
  },
  {
    target: "shared-profiles-title",
    title: "🤝 Perfiles Compartidos",
    description: "Esta es la página central para gestionar todos tus perfiles compartidos. Desde aquí puedes unirte a perfiles existentes o crear nuevos.",
    route: "/shared",
    placement: "bottom",
    action: "close-bubble-menu",
  },
  {
    target: "create-shared-profile-btn",
    title: "✨ Crear Nuevo Perfil",
    description: "Si tocas aquí, crearás un nuevo espacio financiero del cual serás dueño. Luego podrás compartirle el código a otros para que se unan.",
    route: "/shared",
    placement: "bottom",
  },
  {
    target: "join-shared-profile-btn",
    title: "🔗 Unirse a un Perfil",
    description: "Usa esta opción para ingresar el código de 8 caracteres que alguien más te haya compartido para ingresar a su grupo.",
    route: "/shared",
    placement: "bottom",
  },
  {
